...
* team page
    - Currently the [landing page of the Team](https://github.com/zihaowang/zihaowang.github.io/blob/master/team/index.md) is four-column circular headshots (without stacking if the screen is wider than 576px). The circular image is achieved via `border-radius: 50%` - one may remove this to return to rectangular.
